...
public class Erweima2 {
	...
	public static void main(String[] args) {
		File logoFile = new File("D://QrCode/1.jpg"); //logo
        File QrCodeFile = new File("D://QrCode/123.png"); //二维码生成地址以及名称格式
        String url = "https://www.baidu.com/"; //扫描二维码进入网址
        String url1 = "https://blog.csdn.net/jam_fanatic/article/details/82818857/";
        String note = "我的二维码";    //标题
        Erweima2.drawLogoQRCode(logoFile, QrCodeFile, url1, note);
