...
public class testXSSFpage {
	...
	public void pageSheetExcel(){
		...
		String[][] dataMsg = new String[137][5];
		...
		for(int k = 0 ; k<pageSheet; k++){
			int s = k+1;
			HSSFSheet sheet = wk.createSheet("第" + s + "页");
			...
			if(k != pageSheet-1){
				...
				System.out.println(dataMsg[0].length);
	...
	public static void main(String[] args) {
		new testXSSFpage().pageSheetExcel();
	}
}